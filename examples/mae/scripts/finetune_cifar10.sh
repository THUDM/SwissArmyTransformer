...
run_cmd="${OPTIONS_NCCL} ${OPTIONS_SAT} deepspeed --include localhost:1,2,3 --master_port 16666 --hostfile ${HOST_FILE_PATH} finetune_mae_cifar10.py ${gpt_options}"
echo ${run_cmd}
eval ${run_cmd}
