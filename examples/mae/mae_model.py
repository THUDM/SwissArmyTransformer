...
class MAE(EncoderDecoderModel):
    ...
    def encode(self, input_ids, position_ids, attention_mask=None, **kw_args):
        encoder_outputs, *_, dic_buffer = self.encoder(input_ids, position_ids, attention_mask, **kw_args)
        return encoder_outputs, dic_buffer
    ...
    def forward(self, input_ids, enc_position_ids, dec_position_ids, *, enc_attention_mask=None, dec_attention_mask=None, **kw_args):
        ...
        encoder_outputs, dic_buffer = self.encode(input_ids, enc_position_ids, enc_attention_mask, **kw_args)
        decoder_outputs, *mems = self.decode(input_ids, dec_position_ids, dec_attention_mask, encoder_outputs=encoder_outputs, ids_restore=dic_buffer["ids_restore"], **kw_args)
        return encoder_outputs, decoder_outputs, dic_buffer, *mems
