...
source $main_dir/config/model_clip_ft.sh
...
run_cmd="${OPTIONS_NCCL} deepspeed --include localhost:2,3,4,5,7,9 --master_port 16666 --hostfile ${HOST_FILE_PATH} finetune_clip_cifar10.py ${gpt_options}"
echo ${run_cmd}
eval ${run_cmd}
