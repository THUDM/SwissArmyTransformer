...
def create_dataset_function(path, args):
    ...
    if dataset_name == "rte":
        ...
        return load_hf_dataset(path, process_fn, columns = ["input_ids", "position_ids", "attention_mask", "label"], cache_dir='/sharefs/cogview-new/yzy/SwissArmyTransformerDatasets', offline=False, transformer_name=transformer_name)
